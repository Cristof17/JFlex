 ...
 * from the specification file <tt>fisier.flex</tt>
 */
public class Fisier {
  ...
  private static final String ZZ_ACTION_PACKED_0 =
    "\1\0\4\1\1\2\1\3\1\0\1\4\6\0\1\5";
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 =
    "\1\0\1\11\3\1\2\11\1\0\1\11\6\0\1\11";
   ...
   */
  public Fisier(java.io.Reader in) {
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java Fisier [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
